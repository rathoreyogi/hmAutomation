...
public class CLSLogin extends CLSRegressionSuiteBaseImpl {

	final static Logger LOG = Logger.getLogger(CLSLogin.class);

	private final static String TESTCASE = "Starting CLLogin Test";
	...
	public void cllogintest(String url, String browser, String username, String password)
			throws Exception {
