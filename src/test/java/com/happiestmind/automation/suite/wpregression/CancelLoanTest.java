...
public class CancelLoanTest extends WPRegressionSuiteBaseImpl {

	final static Logger LOG = Logger.getLogger(CancelLoanTest.class);

	private final static String TESTCASE = "Starting user Cancel Loan test";
	...
	private final static String STEP92 = "Click on Cancel loan button";
	private final static String STEP93 = "Click on partial application link under previous loan";
	private final static String STEP94 = "Click first Check Box Agreement";
	private final static String STEP95 = "Click I Agree Button contract page";
	private final static String STEP96 = "Click Accept And Continue Button";
	private final static String STEP97 = "Click Go to Dashboard Button";
	private final static String STEP98 = "Ckecl SPL on Dashboard Button";
	...
	public void cancelLoan(String url, String browser, String firstname, String lastname, String dob,
		...
		try {
			...
			/* STEP92 */
			MiscUtils.pauseForElementToBePresent(3000L);
			loanAgrementSignPage.clickCancelLoanApplicationButton(extentLogger, extent, STEP92, className);
			/* STEP93 */
			MiscUtils.pauseForElementToBePresent(10000L);
			dashboardpage.clickPartialApplication(extentLogger, extent, STEP93, className);
			/* STEP94 */
			MiscUtils.pauseForElementToBePresent(3000L);
			loanAgrementSignPage.clickFirstCheckBoxAgrement(extentLogger, extent, STEP94, className);
			/* STEP95 */
			loanAgrementSignPage.clickIAgreeButton(extentLogger, extent, STEP95, className);
			/* STEP96 */
			MiscUtils.pauseForElementToBePresent(3000L);
			loanAgrementSignPage.clickAcceptAndContinueButton(extentLogger, extent, STEP96, className);
			/* STEP97 */
			MiscUtils.pauseForElementToBePresent(4000L);
			loanAgrementSignPage.clickGoToDashboardButton(extentLogger, extent, STEP97, className);
			/* STEP98 */
			MiscUtils.pauseForElementToBePresent(4000L);
			loanAgrementSignPage.clickLoanStatus(extentLogger, extent, STEP98, className);
