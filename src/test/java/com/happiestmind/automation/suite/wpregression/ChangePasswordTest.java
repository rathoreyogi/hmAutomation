...
public class ChangePasswordTest extends WPRegressionSuiteBaseImpl {

	final static Logger LOG = Logger.getLogger(ChangePasswordTest.class);

	private final static String TESTCASE = "Starting ChangePasswordTest";
	...
	private final static String STEP6 = "Click on change password";
	private final static String STEP7 = "Enter old password";
	private final static String STEP8 = "Enter new password";
	private final static String STEP9 = "Enter confirm new password";
	private final static String STEP10 = "Click on submit button";
	private final static String STEP11 = "Click on submit on popup";
	private final static String STEP12 = "Click on username";
	private final static String STEP13 = "Click on signout";
	...
	public void changepasswordtest(String url, String browser, String username, String password, 
		...
		try {
			...
			/* STEP5 */
			MiscUtils.pauseForElementToBePresent(5000L);
			changePassword.clickUserName(extentLogger, extent, STEP5, className);
			/* STEP6 */
			changePassword.clickOnchangepassword(extentLogger, extent, STEP6, className);
			/* STEP7 */
			MiscUtils.pauseForElementToBePresent(3000L);
			changePassword.enterOldPassword(oldpassword, extentLogger, extent, STEP7, className);
			/* STEP8 */
			changePassword.enterNewPassword(newpassword, extentLogger, extent, STEP8, className);
			/* STEP9 */
			changePassword.enterConfirmNewpassword(confirmnewpassword, extentLogger, extent, STEP9, className);
			/* STEP10 */
			changePassword.clicksubmitChangePasswordButton(extentLogger, extent, STEP10, className);
//TODO:  Need R&D to update new password to excel			
			/* STEP11 */
			MiscUtils.pauseForElementToBePresent(1000L);
			changePassword.clicksubmitButtonOnPopup(extentLogger, extent, STEP11, className);
			/* STEP12 */
			MiscUtils.pauseForElementToBePresent(5000L);
